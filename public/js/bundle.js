...
}; // type is success or error, with styles set in our CSS file
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"createCharacter.js":[function(require,module,exports) {
"use strict";
...
var createCharacter = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, level, health, race, strength, dexterity, constitution, intelligence, wisdom, charisma, initiative, ac, charclass, proficiencies, npc) {
    var currentClass, classes, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 3:
            ...
            _context.next = 6;
            return classes.data.data.forEach(function (el) {
          ...
          case 8:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Character created successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
  ...
  return function createCharacter(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15) {
    return _ref.apply(this, arguments);
  };
}();

exports.createCharacter = createCharacter;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"createSpell.js":[function(require,module,exports) {
"use strict";
...
var createSpell = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, desc, higherlvl, level, range, duration, concentration, castingtime, classes) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Spell created successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
  ...
  return function createSpell(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Updated ".concat(type.toUpperCase(), " successfully!"));
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"addSpellsToChar.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addSpellsChar = void 0;
...
var addSpellsChar = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(character, spell) {
    var currentChar, spellsArray, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/characters/".concat(character)
            });

          case 3:
            currentChar = _context.sent;
            spellsArray = [];
            currentChar.data.data.spells.forEach(function (e) {
              return spellsArray.push(e._id);
            });
          ...
          case 9:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Spell added successfully!');
            }
  ...
  return function addSpellsChar(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.addSpellsChar = addSpellsChar;
...
var _createCharacter = require("./createCharacter");

var _createSpell = require("./createSpell");
...
var _addSpellsToChar = require("./addSpellsToChar");
...
var logOutBtn = document.querySelector('.side-nav--logout');
var signupForm = document.querySelector('.form--signup');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var createCharacterForm = document.querySelector('.form-create-character');
var createSpellForm = document.querySelector('.form-create-spell');
var spellSearchForm = document.querySelector('.form-spell-search');
var characterSearchForm = document.querySelector('.form-character-search');
var characterPage = document.querySelector('.character-content-page');
var addSpellPageForm = document.querySelector('.form-add-spell-character');
var spellSpecificForm = document.querySelector('.spell-specific'); // DELEGATION
...
if (createCharacterForm) {
  ...
  createCharacterForm.addEventListener('submit', function (e) {
    ...
    proficiencyTypes.forEach(function (el) {
      document.getElementById(el).checked ? proficiencies.push(el) : '';
    });
    var npc = document.getElementById('npc').checked;
    (0, _createCharacter.createCharacter)(charname, level, health, race, strength, dexterity, constitution, intelligence, wisdom, charisma, initiative, ac, charclass, proficiencies, npc);
  });
}

if (createSpellForm) {
  var classTypes = (['barbarian', 'bard', 'cleric', 'druid', 'fighter', 'monk', 'paladin', 'ranger', 'rogue', 'sorcerer', 'warlock', 'wizard'], _readOnlyError("classTypes"));
  var classes = [];
  createSpellForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var spellname = document.getElementById('spellname').value;
    var desc = document.getElementById('desc').value;
    var higherlvl = document.getElementById('higherlvl').value;
    var level = document.getElementById('level').value;
    var range = document.getElementById('range').value;
    var duration = document.getElementById('duration').value;
    var castingtime = document.getElementById('castingtime').value;
    var conc;
    document.getElementById('concentration').checked ? conc = 'yes' : conc = 'no';
    classTypes.forEach(function (el) {
      return document.getElementById(el).checked ? classes.push(el) : '';
    });
    (0, _createSpell.createSpell)(spellname, desc, higherlvl, level, range, duration, conc, castingtime, classes);
  });
}

if (spellSearchForm) {
  spellSearchForm.addEventListener('submit', function (e) {
    var searchquery = document.getElementById('search').value;
    var sortBy = document.getElementById('sortBy').value;
    var perPage = document.getElementById('perPage').value;
    e.preventDefault();
    location.assign("/spell-list?sort=".concat(sortBy.toLowerCase(), "&limit=").concat(perPage).concat(searchquery ? '&name=' : '').concat(searchquery));
  });
}

if (characterSearchForm) {
  characterSearchForm.addEventListener('submit', function (e) {
    var searchquery = document.getElementById('search').value;
    var sortBy = document.getElementById('sortBy').value;
    var perPage = document.getElementById('perPage').value;
    e.preventDefault();
    location.assign("/character-list?sort=".concat(sortBy.toLowerCase(), "&limit=").concat(perPage).concat(searchquery ? '&name=' : '').concat(searchquery));
  });
}

if (characterPage) {
  var overviewBtn = document.querySelector('.btn-overview');
  var spellsBtn = document.querySelector('.btn-spells');
  var inventoryBtn = document.querySelector('.btn-inventory');
  var featuresBtn = document.querySelector('.btn-features');
  var skillsBtn = document.querySelector('.btn-skills');
  var overview = document.getElementById('overview');
  var spells = document.getElementById('spells');
  var features = document.getElementById('features');
  var inventory = document.getElementById('inventory');
  var skills = document.getElementById('skillSection');
  var collection = [overview, spells, features, inventory, skills];

  var sectionClick = function sectionClick(button, section) {
...
if (addSpellPageForm) {
  addSpellPageForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var character = document.getElementById('character').value.split(':')[0];
    var spell = document.getElementById('spell').value.split(':')[0];
    (0, _addSpellsToChar.addSpellsChar)(character, spell);
  });
}
